...
function WorkflowSection() {
  ...
  return (
    <Section id="workflow" background="white" padding="default">
      <FadeUp className="mb-14 max-w-2xl text-left">
        <SectionLabel className="mb-4">How It Works</SectionLabel>
        <h2 className="type-section-title">
          From setup to <span className="text-primary">full growth</span> in days.
        </h2>
      </FadeUp>
            ...
            {WORKFLOW_STEPS.map((step, index) => {
              ...
              return (
                <div
                  ...
                  tabIndex={0}
                  className={cn(
                    'group focus-visible:ring-primary relative flex w-full cursor-pointer flex-col rounded-[18px] border p-5 text-left transition-all duration-300 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none sm:p-6',
                    isActive
                      ...
                      <AnimatePresence initial={false}>
                        {isActive && (
                          ...
                          >
                            <p
                              className={cn(
                                'font-body max-w-xl pb-1 pt-1 text-sm leading-relaxed',
