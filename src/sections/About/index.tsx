...
import { continuousMotion, hoverMotion } from '@/animations';
    ...
    <Section id="about" background="white" padding="default">
      <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
        <FadeLeft>
          ...
          <HighlightHeading highlight="care deeply." className="mb-6">
            Built by healthcare technologists who
          </HighlightHeading>
          <div className="mb-8 max-w-[540px] space-y-5">
            <BodyText>
              MyDoctorCapsule was born in 2022 from a simple frustration -
              brilliant doctors with life-changing expertise were invisible
              online while patients struggled to find them. Our founding team of
              ex-healthcare executives, digital marketers, and engineers decided
              to fix that.
            </BodyText>
            <BodyText>
              Today we operate in 18 cities, serve 2,400+ clinicians, and have
              helped facilitate over 180,000 patient appointments. We&apos;re
              not just a SaaS company - we&apos;re a growth partner embedded in
              India&apos;s healthcare ecosystem.
            </BodyText>
          </div>
          <div className="grid w-full max-w-[540px] grid-cols-1 gap-3 sm:grid-cols-3">
            {ABOUT_STATS.map((card) => (
              <motion.div
                key={card.title}
                className="card-kpi hover:border-primary/20 px-5 py-3.5 transition-all duration-300 hover:shadow-[var(--shadow-card-hover)]"
